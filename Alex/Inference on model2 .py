...
cr0 = interpolate.interp1d(x0_left, YR0,fill_value="extrapolate")
xnew = np.linspace(0, 1254.5, 500)
yrnew0 = cr0(xnew)

cg0 = interpolate.interp1d(x0_left, YG0,fill_value="extrapolate")
ygnew0 = cg0(xnew)

s0 = interpolate.interp1d(x0_left, S0,fill_value="extrapolate")
snew0 = s0(xnew)
