...
axis[0,0].plot(val,prof01, color = 'b')
axis[0,0].plot(val,prof02, color = 'r')
...
axis[0,0].plot(pmle1[0], profile_parameter(negloglike1, [pmle1[0]], 0, len(ptrue1), pmle1), 'ro')
axis[0,0].plot(pmle2[0], profile_parameter(negloglike2, [pmle2[0]], 0, len(ptrue2), pmle2), 'bo')
...
axis[0,1].plot(val1,prof11, color = 'b')
axis[0,1].plot(val1, prof12, color = 'r')
axis[0,1].axhline(y=h1, color='b',linestyle='--')
axis[0,1].axhline(y=h2, color = 'r', linestyle = '--')
axis[0,1].plot(pmle1[1], profile_parameter(negloglike1, [pmle1[1]], 1, len(ptrue1), pmle1), 'ro')
axis[0,1].plot(pmle2[1], profile_parameter(negloglike2, [pmle2[1]], 1, len(ptrue2), pmle2), 'bo')
...
axis[0,2].plot(val2,prof21, color = 'b')
axis[0,2].plot(val2, prof22, color = 'r')
axis[0,2].axhline(y=h1, color='b',linestyle = '--')
axis[0,2].axhline(y=h2, color = 'r', linestyle ='--')
axis[0,2].plot(pmle1[2], profile_parameter(negloglike1, [pmle1[2]], 2, len(ptrue1), pmle1), 'ro')
axis[0,2].plot(pmle2[2], profile_parameter(negloglike2, [pmle2[2]], 2, len(ptrue2), pmle2), 'bo')
...
axis[1,0].plot(val3,prof31, color = 'b')
axis[1,0].plot(val3, prof32, color = 'r')
axis[1,0].axhline(y = h1, color = 'b', linestyle = '--')
axis[1,0].axhline(y=h2, color='r',linestyle='--')
axis[1,0].plot(pmle1[3], profile_parameter(negloglike1, [pmle1[3]], 3, len(ptrue1), pmle1), 'ro')
axis[1,0].plot(pmle2[3], profile_parameter(negloglike2, [pmle2[3]], 3, len(ptrue2), pmle2), 'bo')
...
axis[1,1].plot(val4,prof41, color = 'b')
prof42 = profile_parameter(negloglike2, val4,4,len(ptrue2), pmle2)
axis[1,1].plot(val4, prof42, color ='r')
axis[1,1].axhline(y=h1, color='b',linestyle='--')
axis[1,1].axhline(y = h2, color = 'r', linestyle = '--')
axis[1,1].plot(pmle1[4], profile_parameter(negloglike1, [pmle1[4]], 4, len(ptrue1), pmle1), 'ro')
axis[1,1].plot(pmle2[4], profile_parameter(negloglike2, [pmle2[4]], 4, len(ptrue2), pmle2), 'bo')
...
axis[1,2].plot(val5,prof5)
axis[1,2].axhline(y=h2, color='k',linestyle='--')
axis[1,2].set(xlabel='alpha')
axis[1,2].plot(pmle2[5], profile_parameter(negloglike2, [pmle2[5]], 5, len(ptrue2), pmle2), 'ro')
