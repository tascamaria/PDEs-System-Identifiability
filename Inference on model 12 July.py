...
val = np.linspace(0.00001,0.00005,10)
...
plt.scatter(xdata,ydata[0,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[0,],color='b',label="Model")

plt.subplot(3,3,2)
plt.scatter(xdata,ydata[1,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[1,],color='m',label="Model")

plt.subplot(3,3,3)
plt.scatter(xdata,ydata[2,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[2,],color='g',label="Model")

plt.subplot(3,3,4)
plt.scatter(xdata,ydata[3,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[3,],color='r',label="Model")

plt.subplot(3,3,5)
plt.scatter(xdata,ydata[4,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[4,],color='c',label="Model")

plt.subplot(3,3,6)
plt.scatter(xdata,ydata[5,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[5,],color='y',label="Model")

plt.subplot(3,3,7)
plt.scatter(xdata,ydata[6,],color='k',label="Data")
plt.plot(xdata,solve_model(pmle)[6,],color='k',label="Model")

# Profile loglikelihood for a parameter
plt.subplot(3,3,8)
